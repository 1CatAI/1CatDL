...
| --- | ---: | ---: | --- | --- | --- |
| 单卡 | 16 | 62.5 GB | 独占一张 Gaudi2 | 单卡运营价，启动成功后锁价 | 最多 1 台 GPU 实例 |
| 四卡 | 64 | 250 GB | 同节点完整四卡组 | 单卡价 × 4，启动成功后锁价 | 最多 1 台 GPU 实例 |
| 八卡 | 128 | 480 GB | 同节点全部八卡 | 单卡价 × 8，启动成功后锁价 | 最多 1 台 GPU 实例 |
